<!-- Navbar-->
      ...
      <div class="content-wrapper">
        <div class="page-title">
          <div>
            <h1><i class="fa fa-medkit"></i> Input Data Obat</h1>
            <p> Staff Logistik</p>
          </div>
          <div>
            <ul class="breadcrumb">
                    ...
                    <div class="col-lg-6">
                        <form role="form" action="<?php echo base_url('c_logistik/simpan_obat');?>" method="post" onsubmit="register()">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" required placeholder="Nama Obat" name="nama">
                            </div>

                            <div class="form-group">
                                <label>Jenis</label>
                                <select class="form-control" id="select" name="jenis" required>
                                    <optgroup label="Jenis Obat">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="number" required name="harga" step="50" min="50" max="5000000">
                            </div>

                            <div class="form-group">
                                <label>Stok Awal</label>
                                <input class="form-control" type="number" required name="stok" step="1" min="0" max="100000">
                            </div>
